 ...
 * @property {import("../../../../../packages/types").PlayerRecordSanitized} currentTarget
 * @property {import("../../../../../packages/types").PlayerRecord} player
 * @property {import("../../../../../packages/types").GameActionRecord} action
 *
...
function HeroContentAlive({ currentTarget, currentAction, player }) {
  ...
  return (
    <>
      ...
      <p className="mb-2">
        {t("PlayerDashboardGameStartedKillCard.communicateYourKilledToken")}:{" "}
 ...
 * @typedef Props
 * @property {import("../../../../../packages/types").PlayerRecord} player
 * @property {import("../../../../../packages/types").GameRecordSanitized} game
 * @property {import("../../../../../packages/types").PlayerRecordSanitized[]} players
 *
 * @param {{player: import("../../../../../packages/types").PlayerRecord, game: import("../../../../../packages/types").GameRecord}} param0
 */
export default function PlayerDashboardGameStarted({ player, game, players }) {
  const { t } = useTranslation("player-dashboard");
  const { t: tCommon } = useTranslation("common");
  const { playerStatusError, playerStatusLoading, playerStatus, load } =
