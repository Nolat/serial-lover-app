...
export default function GameTutorialExample() {
  ...
  /** @type {import("../../../../../packages/types").PlayerRecord} */
  ...
  /** @type {import("../../../../../packages/types").GameActionRecord} */
  ...
  /** @type {import("../../../../../packages/types").GamePlayersTable} */
  const table1 = [
  ...
  /** @type {import("../../../../../packages/types").GameDashboard['podium']} */
  const podium = [
