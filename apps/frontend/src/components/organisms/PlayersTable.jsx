 ...
 * @property {(player: import("../../../../../packages/types").PlayerRecord) => void} [onEditClick]
 * @property {(player: import("../../../../../packages/types").PlayerRecord) => void} [onDeleteClick]
 * @property {(player: import("../../../../../packages/types").PlayerRecord) => void} [onMoveUp]
 * @property {(player: import("../../../../../packages/types").PlayerRecord) => void} [onMoveDown]
 *
